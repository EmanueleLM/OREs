...
tf_model_path = KERAS_REL_PATH + 'fc-{}inp-32hu-keras-IMDB-{}d'.format(num_words, emb_dims)
...
log_results, logs_path = True, "HS-clear/HS_CLEAR_IMDB_fc_{}_inp_{}d_knn_linf/HS_CLEAR_results_smallest_expl_IMDB_fc_{}_inp_{}d".format(num_words, emb_dims, num_words, emb_dims)  # write results on file

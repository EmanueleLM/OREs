...
from abduction_algorithms_cost import logger, knn_smallest_cost_explanation_linf_alternate_cost_exclude_words
...
from text_utils import test_IMDB
...
tf_model_path = KERAS_REL_PATH + 'fc-{}inp-64hu-keras-IMDB-{}d.h5'.format(num_words, emb_dims)
frozen_graph_prefix, frozen_graph_path = FROZEN_REL_PATH, 'tf_model_IMDB.pb'
log_results, logs_path = True, "MSA_NEW/MSA_NEW_IMDB_fc_{}_inp_{}d_knn_linf/MSA_NEW_results_smallest_expl_IMDB_{}fc_{}_inp_{}d_".format(num_words, emb_dims, prefix, num_words, emb_dims) +  "alternate_cost_exclude"  # write results on file+  
...
#Input: ['#', 'i', 'chose', 'to', 'watch', 'this', 'film', 'because', 'i', 'am', 'a', 'stephen', 'nichols', 'fan', 'unfortunately', 'i', 'am', 'unhappy', 'with', 'mr', 'nichols', 'choice', 'to', 'do', 'this', 'movie', 'the', 'film', 'was', 'slow', 'badly', 'acted', 'and', 'included', 'some', 'very', 'graphic', 'sex', 'scenes', 'of', 'mr', 'nichols', 'character', 'with', 'a', 'very', 'young', 'woman', 'watch', 'at', 'your', 'own', 'peril']

#excluding 'stephen', 'nichols', 'nichols'
words = [[55,56,5,58,59], [60,61,62,63,64], [100,101,102,103,104]]
h, exec_time = knn_smallest_cost_explanation_linf_alternate_cost_exclude_words (model, filename, x, words, minmax_input_bounds, [eq_convex_hull, minmax_input_bounds], output_constraints, num_words, uniform, weights_softmax, window_size, cost_func,  verbose=verbose)

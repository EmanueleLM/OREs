...
log_results, logs_path = True, "MSA_NEW/MSA_NEW_IMDB_fc_{}_inp_{}d_knn_linf/MSA_NEW_results_smallest_expl_IMDB_{}fc_{}_inp_{}d_".format(num_words, emb_dims, prefix, num_words, emb_dims) +  "alternate_cost"  # write results on file+  

...
parser.add_argument('-i', '--input', dest='input', type=str, default='It is amusing and that is all it needs to be', help='input string')
...
# Global Variables
prefix = 'robust-'  # may be set to 'robust-' to try IBP-trained models
verbose = True
...
# Report MSR found
logger("Minimum Size Explanation found {}".format(h), True)

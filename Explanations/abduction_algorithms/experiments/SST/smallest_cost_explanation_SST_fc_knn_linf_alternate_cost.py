...
frozen_graph_path = 'tf_model_SST_25inp_5d.pb'
emb_dims = 5
input_len = emb_dims*25
num_words = int(input_len/emb_dims)

log_results, logs_path = True, "MSA_NEW/MSA_NEW_SST_fc_{}_inp_{}d_knn_linf/MSA_NEW_results_smallest_expl_SST_{}fc_{}_inp_{}d_".format(num_words, emb_dims, prefix, num_words, emb_dims) + "alternate_cost"  # write results on file+  

model_input_shape = (1, emb_dims*num_words)
tf_model_path = KERAS_REL_PATH + 'fc-{}inp-16hu-keras-SST-{}d'.format(num_words, emb_dims)
frozen_graph_prefix, frozen_graph_path = FROZEN_REL_PATH, 'tf_model_SST_25inp_5d.pb'
...
output_constraints = [y_hat, (1 if y_hat==0 else 0), 1e-2]
print("output_constraints", output_constraints)

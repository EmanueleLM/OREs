...
log_results, logs_path = True, "MSA_NEW/MSA_NEW_SST_fc_{}_inp_{}d_knn_linf/MSA_NEW_results_smallest_expl_SST_{}fc_{}_inp_{}d_".format(num_words, emb_dims, prefix, num_words, emb_dims) +  "alternate_cost_exclude"  # write results on file+  
...
acc = test_SST(load_model(tf_model_path, compile=True), index2embedding, word2index, [num_words*emb_dims], num_words, emb_dims, data_path='./../../../data/SST_2')
